        ...
        <article className="max-w-3xl mx-auto p-8">
          ...
          <header className="mb-6 pb-4 border-b-2 border-border">
            ...
            <div className="flex items-center gap-2 mt-2">
              {charData?.role && <Badge variant="outline">{charData.role}</Badge>}
              {loreData?.category && <Badge variant="outline">{loreData.category}</Badge>}
              {loreData && (
          ...
          {charData && (
            <div className="space-y-6 prose prose-sm dark:prose-invert max-w-none">
              ...
              {charData.goals && (
                <section>
                  <h2 className="text-lg font-semibold mb-2">Goals & Motivations</h2>
